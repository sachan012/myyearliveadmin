...
$image_path = 'http://'.$_SERVER['SERVER_NAME'].'/myyearliveadmin/assets/uploads';
define('UPLOAD_PATH',$image_path);
define('FRONT_END_LIMIT','10');
define('DEFAULT_NO_IMAGE',UPLOAD_PATH.'noImg/noImg.jpg');
define('ADMIN_COMPANY','myyearliveadmin');
/*define('ADMIN_NOTIFICATION_EMAIL', 'rinfo@triazinesoft.com');
define('ADMIN_NOTIFICATION_TITLE', 'Triazinesoft');*/
define('FIREBASE_API_ACCESS_KEY', 'AAAAG5dH1aQ:APA91bFRBMhqn8HZsHtvF-7NYjmRpPZGVdGSzSzYVc8kPcCStlnwSNvEK2XrndNHDycwtPDdpCsq2ueaLrulbAqdjPaNA6dksL4qYrTCT9e9C_4U9vHKtNOo_yStfdXjFUImjrijidSm'); 
