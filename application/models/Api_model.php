...
public function logout() {
    ...
    public function firebase_userid_exists($frbseId){       
        $rows = $this->db->select('firebase_user_id')->where('firebase_user_id',$frbseId)->get('users')->num_rows();
    ...
    function update_device_token($frbseId,$dataarray){        
        $this->db->set($dataarray);
        $this->db->where('firebase_user_id',$frbseId);
