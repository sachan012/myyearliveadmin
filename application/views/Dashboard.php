            ...
            <div class="small-box bg-info">
              ...
              <div class="icon">
               <!--  <i class="ion ion-person"></i> -->
                <img src="<?php echo base_url();?>assets/uploads/dashboard_icon/customers.png" class="img-responsive">
              </div>
              <a href="<?php echo base_url("users/index/all");?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
