              ...
              <div class="card-body box-profile">
                <div class="text-center">
                  <?php if(!empty($aminDetails["profileicon"])) {
                      $file_pointer = UPLOAD_PATH."/AdminUser/".$aminDetails["profileicon"];
                      if (file_exists($file_pointer)) {
                          $src = UPLOAD_PATH."/AdminUser/".$aminDetails["profileicon"];
                      }else {
                        $src = UPLOAD_PATH."/default/default-user.png";
                      }
                  ...
                  <?php } else { ?>
                     <img class="profile-user-img img-fluid img-circle"
                       src="<?php echo UPLOAD_PATH."/default/default-user.png";?>"
                       alt="User profile picture">
                  <?php } ?>                       
                </div>
