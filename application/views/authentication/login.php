...
<body class="hold-transition login-page" style="background-image: url(<?php echo base_url("assets/login-background.jpg");?>); background-repeat: no-repeat; background-size: cover;">
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg"><strong><?php echo ADMIN_COMPANY;?> Admin Login</strong></p>
     ...
     <!--     <span id="password_error"></span> -->
        <div class="row">
           <!-- /.col -->
           <div class="col-6">
            <a href="<?php echo base_url("forget-password");?>" style="display:none;">I forgot my password</a>
          </div>
          <!-- /.col -->
