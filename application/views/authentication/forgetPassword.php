...
<body class="hold-transition login-page" style="background-image: url(<?php echo base_url("assets/login-background.png");?>); background-repeat: no-repeat; background-size: cover;">
