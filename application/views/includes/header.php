...
{
  redirect(base_url());  // getting the login user name with trim
}
    ...
    <li class="dropdown" style="width: 10rem;">
        <a style="color: black" href="#" data-toggle="dropdown" class="dropdown-toggle clear" data-toggle="dropdown">
              <span class="thumb-sm avatar pull-right m-t-n-sm m-b-n-sm m-l-sm">
                    ...
                    <img alt="Admin Profile Pic" height="40" width="40" class="img-full" src="<?php echo assets_url('uploads/default/','default-user.png'); ?>">
        ...
        <!-- dropdown -->
        <ul class="dropdown-menu animated fadeInRight w" style="margin-top: 10px;  min-width: 13rem; padding-left:10px;" >
           <li class="dropstyle">
